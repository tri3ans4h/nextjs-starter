    ...
    >
        ...
        return (
          <motion.button
            ...
            className={classNames(
              'text-xs md:text-lg relative rounded-md flex items-center h-10 px-2 z-20 bg-transparent  cursor-pointer select-none transition-colors hover:text-black mb-0.5',
              {
                ' text-black/40': !isActive, // Default color for non-active tabs
      ...
      <AnimatePresence>
        {hoveredRect && navRect && (
          <motion.div
            key={'hover'}
            className="absolute p-1 mb-1 z-10 top-0 left-0 rounded-md bg-zinc-200  "
            initial={{
